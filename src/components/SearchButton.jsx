...
const SearchButton = ({ onClick, visible = true, title, icon, style }) => {
  ...
  return (
    ...
    <button
      onClick={onClick}
      className={`w-[300px]  mt-auto ${style} text-secondary  items-center justify-center gap-3 flex font-mono text-lg active:scale-95 duration-100 bg-detail h-[56px] rounded-md`}
