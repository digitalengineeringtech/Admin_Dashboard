...
// import DeviceNest from "./DeviceNest";
...
const Device = () => {
  ...
  return (
    <div className="flex flex-col   items-center">
      ...
      {/* <DeviceNest handleReset={handleReset} handleAdd={handleAdd} header={header} stockRow={stockRow} dispenser={dispenser} dis={dis} setDis={setDis} nozzle={nozzle} noz={noz} setNoz={setNoz} fuelType={fuelType} fuel={fuel} setFuel={setFuel} brandType={brandType} brand={brand} setBrand={setBrand} /> */}
      <Outlet />
      {/* <div className="">
